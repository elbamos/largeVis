...
* This implementation uses C++ implementations of the most computationally intensive phases: exploring the random projection trees, neighborhood exploration, calculating $p_{j|i}$, and the final calculation of the embeddings using sgd.  The implementation will attempt to use OpenMP if it is available.  
