...
if (file.exists(paste(vdatapath, "mnistcoords.Rda", sep = ""))) {
  ...
  ggplot(mnistCoords, aes(x = x, y = y, color = labels)) +
    ...
    scale_x_continuous(name = "", limits = c(-47, 40), breaks = NULL) +
    scale_y_continuous(name = "", limits = c(-40, 40), breaks = NULL) +
    scale_color_manual(values = colors_divergent_discrete(10)(10)) +
    guides(colour = guide_legend(override.aes = list(size=5))) +
    ggtitle(expression(
      atop("MNIST",
           italic("(n = 70000, K = 100, n_trees = 50, threshold = 700)")
           )
      ))
} 
```
...
if (file.exists("../largeVisData/mnist/train.RData") && exists("mnistCoords")) {
...
if (file.exists(datapath)) {
  ...
  ggplot(docs, aes(x = x, y = y, color = as.numeric(label))) + 
    ...
    scale_color_gradientn(colors = colors_divergent_discrete(11)(11)) +
    guides(color = FALSE) +
    scale_x_continuous("", limits = c(-55, 50), breaks = NULL) + 
